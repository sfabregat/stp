...
<body>
    ...
    <div class="cabecera2">
        <div class="header_wrap">
                ...
                <a href="registre" class="black"><span class="glyphicon glyphicon-user" id="gly"></span> Register</a>
                <a href="login" class="black"><span class="glyphicon glyphicon-log-in" id="gly"></span> Login</a>
                </div>
        </div>          
    </div>
    <div class="cabecera3">
        <div class="cabecera3_wrap">
            ...
            <div class="cabecera3_wrap_box"><a href="login"><b>Historias</b></a></div>
            <div class="cabecera3_wrap_box"><a href="login"><b>Mas Valoradas</b></a></div>
            <div class="cabecera3_wrap_box"><a href="login"><b>Mis Historias</b></a></div>
            <div class="cabecera3_wrap_box"><a href="login"><b>Usuarios</b></a></div>
